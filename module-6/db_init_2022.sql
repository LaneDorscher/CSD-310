...
DROP USER IF EXISTS 'movies_user'@'172.17.0.1';

-- create movies_user and grant them all privileges to the movies database 
CREATE USER 'movies_user'@'172.17.0.1' IDENTIFIED WITH caching_sha2_password BY 'popcorn';
...
GRANT ALL PRIVILEGES ON movies.* TO 'movies_user'@'172.17.0.1';
